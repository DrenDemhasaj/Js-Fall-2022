...
const updateStudentRecord2_1 = allStudentData2_1.map((nameToTitleCase)=>nameToTitleCase.name)
console.log(sentTitle(updateStudentRecord2_1.name))

// function updateStudentRecord2_1 (nameToTitleCase){
...
//     if (allStudentRecords_3.name !== newFirstName){
//         updateFirstName.replace(updateFirstName.name,newFirstName)
//     }
// }
